...
void Cal_T_gripper2base(std::vector<cv::Mat>& T_gripper2base); // 计算gripper2base T
void Cal_R_gripper2base(std::vector<cv::Mat>& R_gripper2base); // 计算gripper2base R
void Cal_R_T_target2cam(std::vector<cv::Mat>& R_target2cam, std::vector<cv::Mat>& T_target2cam); // 计算target2cam R T
